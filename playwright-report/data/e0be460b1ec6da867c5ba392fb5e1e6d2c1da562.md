...
- Name: autonomous-agent.spec.ts >> Autonomous Agent >> agent memory tab works
- Location: tests\autonomous-agent.spec.ts:32:7
...
Locator: locator('text=Agent Memory')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Agent Memory')
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e81]:
    ...
    - link "Patterns" [ref=e93] [cursor=pointer]:
      - /url: /patterns
      - img [ref=e95]
      - generic [ref=e99]: Patterns
    - link "Sandbox" [ref=e100] [cursor=pointer]:
      - /url: /sandbox
      - img [ref=e102]
      - generic [ref=e104]: Sandbox
    - link "Monitor" [ref=e105] [cursor=pointer]:
      - /url: /monitoring
      - img [ref=e107]
