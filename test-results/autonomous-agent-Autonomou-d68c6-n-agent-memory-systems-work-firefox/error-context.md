...
- Name: autonomous-agent.spec.ts >> Autonomous Agent Integration >> agent memory systems work
- Location: tests\autonomous-agent.spec.ts:240:7
...
Locator: locator('text=Short-term Memory')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Short-term Memory')
                ...
                - generic [ref=e104]:
                  ...
                  - generic [ref=e107]:
                    ...
                    - combobox [ref=e108]:
                      ...
                      - option "High"
                  - button "Add Task" [ref=e110] [cursor=pointer]:
                    - img [ref=e111]
                    - text: Add Task
              - generic [ref=e114]:
